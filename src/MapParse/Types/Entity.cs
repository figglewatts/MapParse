...
namespace MapParse.Types
{
    public class Entity
    {
        ...
        public int NumberOfBrushes { get { return Brushes.Length; } }

        /// <summary>
        /// Get a property value from this entity by property name.
        /// </summary>
        public string GetPropertyValue(string propertyName) { return Properties[propertyName]; }
        ...
        /// </summary>
        public void AddProperty(string key, string val) { Properties.Add(key, val); }

        public void AddProperty(Property p) { Properties.Add(p.Key, p.Value); }
